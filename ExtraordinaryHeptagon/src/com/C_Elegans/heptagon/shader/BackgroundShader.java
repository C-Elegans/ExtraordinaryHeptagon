...
public class BackgroundShader extends ShaderProgram{
	private static final String VERTEX_FILE = "shaders/backgroundVertexShader.txt";
	private static final String FRAGMENT_FILE = "shaders/backgroundFragmentShader.txt";
	...
	public void changeColor(Color color){
		...
		//super.loadVector(location_colorInput, new Vector3f(.5f,.5f,.5f));
	}
